...
public class EscapeSequences {
    ...
    private static final String ANSI_ESCAPE = "\033"; // Not directly used in these constants, but kept as in your original

    public static final String ERASE_SCREEN = UNICODE_ESCAPE + "[H" + UNICODE_ESCAPE + "[2J";
    public static final String ERASE_LINE = UNICODE_ESCAPE + "[2K";
    public static final String SET_CURSOR_TO_HOME_POSITION = UNICODE_ESCAPE + "[H"; // Añadido para posicionar el cursor al inicio
    ...
    public static final String SET_TEXT_COLOR_CYAN = SET_TEXT_COLOR + "6m"; // Añadido SET_TEXT_COLOR_CYAN
    public static final String SET_TEXT_COLOR_WHITE = SET_TEXT_COLOR + "15m";
    public static final String RESET_TEXT_COLOR = UNICODE_ESCAPE + "[39m"; // Tu definición original
